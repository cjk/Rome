...
const EntryPage = props => (
  <Layout title="Ebene 3">
    ...
    <Grid container columns={3} stackable>
      <Grid.Column>
        <LevelLink href="/lvl4/leading/starter">
          <Segment padded="very">Neu im Chefsessel</Segment>
        </LevelLink>
      </Grid.Column>
      <Grid.Column>
        <LevelLink href="/lvl4/leading/styles">
          <Segment padded="very">Führungsstile</Segment>
        </LevelLink>
      </Grid.Column>
      <Grid.Column>
